...
const navigation = [
  { name: "Dashboard", href: "/dashboard/jobs", icon: HomeIcon, current: true },
  { name: "Home", href: "/", icon: UsersIcon, current: false },
  { name: "Add Job", href: "#", icon: FolderIcon, current: false },
